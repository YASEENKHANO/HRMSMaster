<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="MasterPageChartPract.index" %>
                                            ...
                                            <div>
                                                <asp:Chart ID="ChartSalesOverview" runat="server">
                                                  <Titles><asp:Title Text="Sales Overview"></asp:Title></Titles>
                                                    ...
                                                    <Series>
                                                        <asp:Series Name="Series1" ChartType="Spline" YValuesPerPoint="2">
                                                              <Points>
                                                                <asp:DataPoint AxisLabel="Jan" YValues="30,0" Color="Red"/>
                                                                <asp:DataPoint AxisLabel="Feb" YValues="40,0"/>
                                                                <asp:DataPoint AxisLabel="Mar" YValues="20,0" Color="Red"/>
                                                                <asp:DataPoint AxisLabel="Apr" YValues="10,0"/>
                                                                <asp:DataPoint AxisLabel="May" YValues="40,0" Color="Red"/>
                                                                <asp:DataPoint AxisLabel="Jun" YValues="30,0"/>
                                                                <asp:DataPoint AxisLabel="Jul" YValues="70,0" Color="Red"/>
                                                                <asp:DataPoint AxisLabel="Aug" YValues="40,0"/>
                                                                <asp:DataPoint AxisLabel="Sep" YValues="60,0" Color="Red"/>
                                                                <asp:DataPoint AxisLabel="Oct" YValues="90,0"/>
                                                                <asp:DataPoint AxisLabel="Nov" YValues="80,0" Color="Red"/>
                                                                <asp:DataPoint AxisLabel="Dec" YValues="40,0"/>
